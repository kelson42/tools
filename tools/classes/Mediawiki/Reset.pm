...
sub reset {
    ...
    foreach my $table ("archive", "category", "categorylinks", "externallinks", "filearchive", "hitcounter", "imagelinks", "langlinks", "logging", "math", "objectcache", "redirect", "page", "pagelinks", "revision", "text", "recentchanges", "searchindex", "templatelinks", "l10n_cache") {
	$req = "TRUNCATE $table";
