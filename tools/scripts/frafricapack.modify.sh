...
#cat fr.mw.help | grep -v -i "^mediawiki:" | ./mirrorMediawikiPages.pl --sourceHost=mediawiki.org --sourcePath=w --destinationHost=fr.africapack.kiwix.org --destinationPath=w --destinationUsername=admin --destinationPassword=adminadmin --readFromStdin --ignoreEmbeddedInPagesCheck --ignoreImageDependences  --ignoreTemplateDependences

# Clean Mediawiki entries
#for ENTRY in `cat fr.mw.help | grep "^Help:"`
#do
...
./listAllPages.pl --host=fr.africapack.kiwix.org --path=w --namespace=0 --namespace=0 > fr.all
./listAllPages.pl --host=fr.africapack.kiwix.org --path=w --namespace=0 --namespace=4 >> fr.all
./listAllPages.pl --host=fr.africapack.kiwix.org --path=w --namespace=0 --namespace=12 >> fr.all
./listAllPages.pl --host=fr.africapack.kiwix.org --path=w --namespace=0 --namespace=3000 >> fr.all
